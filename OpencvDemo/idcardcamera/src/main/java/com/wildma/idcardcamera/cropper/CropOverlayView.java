...
public class CropOverlayView extends View {
    ...
    private com.wildma.idcardcamera.cropper.CropPosition cropPosition;
    ...
    private void resetPoints() {
        ...
        if(getWidth()!=0) {
            ...
            int arry2D[][]=Scan(bitmap);
            if(arry2D[0][0]==0&& arry2D[0][1]==0)
            {
                ...
                maxY = getHeight();
                if (maxScale == scaleY) { // image very tall
                    arry2D[0][1]=(int)(arry2D[0][1]/maxScale);
                    arry2D[1][1]=(int)(arry2D[1][1]/maxScale);
                    arry2D[2][1]=(int)(arry2D[2][1]/maxScale);
                    arry2D[3][1]=(int)(arry2D[3][1]/maxScale);
                } else { // image very wide
                    arry2D[0][0]=(int)(arry2D[0][0]/maxScale);
                    arry2D[1][0]=(int)(arry2D[1][0]/maxScale);
                    arry2D[2][0]=(int)(arry2D[2][0]/maxScale);
                    arry2D[3][0]=(int)(arry2D[3][0]/maxScale);

                }
                topLeft = new Point(arry2D[0][0], arry2D[0][1]);
                topRight = new Point(arry2D[1][0], arry2D[1][1]);
                bottomLeft = new Point(arry2D[3][0], arry2D[3][1]);
                bottomRight = new Point(arry2D[2][0], arry2D[2][1]);
            }
