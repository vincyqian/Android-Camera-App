...
import com.wildma.idcardcamera.utils.PictureUtil;
...
public class CameraActivity extends Activity implements View.OnClickListener {
    ...
    public final static int TYPE_IDCARD_BACK = 0;//身份证反面
    public final static int TYPE_IDCARD_album = 2;//身份证反面
    public final static int REQUEST_CODE = 0X11;//请求码
    public final static int RESULT_CODE = 0X12;//结果码
    private static final int REQUEST_IMAGE_GET = 0X13;
        ...
        switch (mType) {
            ...
            case TYPE_IDCARD_album:
                ...
                if (intent.resolveActivity(getPackageManager()) != null) {
                    ...
                    Toast.makeText(CameraActivity.this, "未找到图片查看器", Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
    ...
    private void initView() {
        ...
        switch (mType) {
            case TYPE_IDCARD_FRONT:
                ...
                mIvCameraCrop.setImageResource(R.mipmap.camera_overpng);
            ...
            public void onFinish(Bitmap bitmap) {
                ...
                if (FileUtils.createOrExistsDir(Constant.DIR_ROOT)) {
                    ...
                    if (mType == TYPE_IDCARD_FRONT) {
                        ...
                        imagePath = buffer.append(Constant.DIR_ROOT).append("idCardFrontCrop.jpg").toString();
                       ...
                       // imagePath = buffer.append(Constant.DIR_ROOT).append(Constant.APP_NAME).append(".").append("idCardBackCrop.jpg").toString();
                        imagePath = buffer.append(Constant.DIR_ROOT).append("idCardBackCrop.jpg").toString();
                    }
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                ...
                case REQUEST_IMAGE_GET:
                    String filepath=PictureUtil.getImageString(this, data);
                    File file = new File(filepath);
                    if(file.exists()){
                        final Bitmap bitmap=BitmapFactory.decodeFile(filepath);
                        setContentView(R.layout.album);
                        mIvCameraCrop = (ImageView) findViewById(R.id.crop_album_view);
                        mImageView=findViewById(R.id.picture_preview);
                        mIvCameraCrop.setImageBitmap(bitmap);
                        new Thread(new Runnable() {
                            @Override
                            public void run() {
                               // Bitmap bitmap = BitmapFactory.decodeByteArray(data, 0, data.length);
